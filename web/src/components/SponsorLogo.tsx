 ...
 */
export type SponsorId = "0g" | "base" | "hedera" | "okx" | "thegraph";
...
const MARKS: Record<SponsorId, Mark> = {
  ...
  /**
   * ⚠️ A WORDMARK, NOT OKX'S LOCKUP. The other four marks are the sponsors' own SVG geometry,
   * generated from /sponsor-logos by scripts/gen-sponsor-logos.mjs and untouched. We have no
   * OKX asset, and drawing their registered mark from memory would break exactly the rule this
   * file states two comments above — so this sets their name in the page's own type instead.
   *
   * TO FIX PROPERLY: drop OKX's official SVG into /sponsor-logos and re-run
   * `node scripts/gen-sponsor-logos.mjs`, then replace this entry with the generated one.
   */
  okx: {
    name: "OKX",
    viewBox: "0 0 120 40",
